...
import { match as _ } from '$/utils/pat/match.ts'

/**
 * Data type for values that may succeed or fail.
 *
 * @note either :: (a -> c) -> (b -> c) -> Either a b -> c
 */
...
/** Guard over {@link Result} */
export type Guard<F, A = F, B = A, C = B> = (a: Result<F, A>) => B | C
